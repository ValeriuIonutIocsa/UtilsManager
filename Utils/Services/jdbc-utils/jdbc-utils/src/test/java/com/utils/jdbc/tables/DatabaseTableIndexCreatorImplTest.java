...
class DatabaseTableIndexCreatorImplTest {
	...
	void testCreateSql() {
		...
		final int[] columnIndices = { 0, 4 };

		final String sql = DatabaseTableIndexCreatorImpl
				.createSql(databaseTableInfo, indexName, columnIndices);
